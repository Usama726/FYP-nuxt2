<template>
  <div>
  <div class="pt-24">
    <h1 class="animate-pulse flex items-center justify-center font-bold text-blue-600 text-lg lg:text-5xl">
      Checkout 
    </h1>
  </div>
          ...
          <div class="">
            ...
            <div class="flex items-center mt-4">
              <label class="flex items-center text-sm group text-heading">
                <input type="checkbox" class="w-5 h-5 border border-gray-300 rounded focus:outline-none focus:ring-1">
                <span class="ml-2">Save this information for next time</span></label>
            </div>
            <div class="relative pt-3 xl:pt-6"><label for="note" class="block mb-3 text-sm font-semibold text-gray-500">
                Notes
