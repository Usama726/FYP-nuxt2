  ...
  <div>
    ...
    <div class="container my-24 mx-auto md:px-6">
      ...
      <section class="mb-32 text-center md:text-left">
        <div
          class="block rounded-lg bg-white border border-blue-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
          <div class="flex flex-wrap items-center">
            <div class="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
              <img src="../assets/images/aboutUsImage.jpg"
            ...
            <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
              <div class="px-6 py-12 md:px-12">
                ...
                <nuxt-link to="/medicines" class="border border-blue-500 px-3 py-2 rounded-lg hover:bg-blue-200">
                  Buy now
                </nuxt-link>
              </div>
            </div>
